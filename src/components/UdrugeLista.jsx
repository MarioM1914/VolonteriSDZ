...
import DodajUdruguButton from './DodajUdruguButton';

function UdrugeLista({ udruge, dodajUdrugu, obrisiUdrugu, fetchUdruge}) {
  return (
    <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
      <div className="flex items-center justify-between flex-column md:flex-row flex-wrap space-y-4 md:space-y-0 py-4 pl-2 bg-white">
        ...
        <DodajUdruguButton dodajUdrugu={dodajUdrugu} />
      </div>
